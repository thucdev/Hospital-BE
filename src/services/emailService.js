...
let sendSimpleEmail = async (dataSend) => {
   ...
   let info = await transporter.sendMail({
      from: '"Thucidol 👻" <thucidol2012@gmail.com>', // sender address
      to: dataSend.receiverEmail, // list of receiverEmail
...
let getBodyHTMLEmail = (dataSend) => {
   ...
   if (dataSend.language === "vi") {
    ...
    <p>Bạn nhận được email này vì đã đặt lịch khám bệnh online trên thucDo.developer</p>
...
let getBodyHTMLEmailRemedy = (dataSend) => {
   ...
   if (dataSend.language === "vi") {
      result = ` <h3> Xin chào ${dataSend.patientName}!</h3>
    <p>Bạn nhận được email này vì đã đặt lịch khám bệnh online trên thucidol.com thành công</p>
        <p>Thông tin đặt lịch khám bệnh được gửi trong file đính kèm</p>
...
let sendAttachment = async (dataSend) => {
   ...
   let info = await transporter.sendMail({
      from: '"Thucidol 👻👻 " <thucidol2012@gmail.com>', // sender address
      to: dataSend.email, // list of receiverEmail
